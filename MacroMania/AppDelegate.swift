...
//        AppDelegate.launchAppControllers()
    ...
    public lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ken.MacroMania" in the application's documents Application Support directory.
    ...
    public lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MacroMania", withExtension: "momd")!
    ...
    public class func createMainTabBarController() -> MainTabBarController {
        ...
        let plannerViewController = HomeViewController(nibName: "HomeViewController", bundle: nil)
        ...
        let settingsViewController = HomeViewController(nibName: "HomeViewController", bundle: nil)
    ...
    private func setupNavBar() {
        ...
        navigationBarAppearance.tintColor = Styles.Colors.AppSilver
        navigationBarAppearance.barTintColor = Styles.Colors.AppBackground
        
        navigationBarAppearance.titleTextAttributes = topBarTextAttributes
        navigationBarAppearance.barStyle = .Default
        
        let barButtonAppearance = UIBarButtonItem.appearance()
        barButtonAppearance.setTitleTextAttributes(barButtonTextAttributes, forState: .Normal)
    }
